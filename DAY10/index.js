...
const whyMiDots = document.getElementById('whyMiDots');
const whyMiSlides = whyMiTrack.children;
const whyMiTotal = whyMiSlides.length;
let whyMiIndex = 0;

// Responsive: show 1 slide at a time on mobile, 2 on tablet, 3 on desktop
...
window.addEventListener('resize', () => {
    ...
    const slidesToShow = getSlidesToShow();
    if (whyMiIndex > whyMiTotal - slidesToShow) whyMiIndex = whyMiTotal - slidesToShow;
    updateCarousel();
});
updateCarousel();